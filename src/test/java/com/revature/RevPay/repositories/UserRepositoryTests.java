...
public class UserRepositoryTests {
    ...
    void insertValidUser(){
        User valid = new User("KyleBreedlove","1111111111","email@email","pass",0,true,false);
    ...
    @Test
    void updateUser(){
        User user = new User("kylebreedlove","111","email","pass");
        userRepository.save(user);
        User updated = new User("kylebreedlove", "22222","second","newPass");
    ...
    void getValidUserByUsername(){
        User testUser = new User("testUser","1111","email","password",0,false,false);
